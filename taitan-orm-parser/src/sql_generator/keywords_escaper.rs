...
pub const MYSQL_KEYWORDS: &[&str] = &[
    ...
    "JOIN", "KEY", "KEYS", "KILL", "LEADING", "LEAVE", "LEFT", "LIKE", "LIMIT", "LINEAR",
...
pub const POSTGRES_KEYWORDS: &[&str] = &[
    ...
    "DEFERRED", "DELETE", "DESC", "DISTINCT", "DO", "ELSE", "END", "EXCEPT",
    "FALSE", "FETCH", "FOR", "FOREIGN", "FREEZE", "FROM", "FULL", "GRANT",
    "GROUP", "HAVING", "ILIKE", "IN", "INITIALLY", "INNER", "INSERT",
...
fn contains_ignore_case<T: AsRef<str>>(haystack: &[T], needle: &str) -> bool {
    ...
    haystack.iter().any(|item| item.as_ref().to_lowercase() == needle_lower)
}
