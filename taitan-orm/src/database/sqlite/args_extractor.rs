...
use taitan_orm_trait::traits::{Entity, Location, Mutation, Parameter, SqliteEntity, Unique};

pub trait SqliteArgsExtractor: SqlGenericExecutor
where
    ...
    i64: Type<<Self as SqlGenericExecutor>::DB>
{
    ...
    fn extract_insert_arguments(entity: &dyn SqliteEntity) -> Result<SqliteArguments<'_>> {
        entity.gen_args()
    }
