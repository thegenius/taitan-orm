...
impl<T> TemplateMutApi for T where T: SqlExecutorMut + SqlGeneratorContainer + Extractor {}

pub trait TemplateMutApi: SqlExecutorMut + SqlGeneratorContainer + Extractor {
