...
//     {
//         let query: Query<'a, DB, A> = sqlx::query_with(stmt, args);
//         let result_opt: Vec<<DB as Database>::Row> = query.fetch_all(ex).await?;
...
//     {
//         let query: Query<'a, DB, A> = sqlx::query_with(stmt, args);
//         let result: <DB as Database>::Row = query.fetch_one(ex).await?;
...
//     {
//         let query: Query<'a, DB, A> = sqlx::query_with(stmt, args);
//         let result_vec: Vec<<DB as Database>::Row> = query.fetch_all(ex).await?;
//         let mut result: Vec<SE> = Vec::new();
