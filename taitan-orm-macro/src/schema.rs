use crate::expands::{generate_entity_impl, generate_location_expr_enum_and_impl, generate_location_struct_and_impl, generate_mutation_struct_and_impl, generate_ordering_struct_and_impl, generate_selected_struct_and_impl, generate_selection_struct_and_impl, generate_unique_structs_and_impls};
...
pub fn impl_schema_macro(input: TokenStream) -> TokenStream {
    ...
    let selected_struct_stream = generate_selected_struct_and_impl(&ident, &attrs, &fields, serde_list.contains(&"selected"));
